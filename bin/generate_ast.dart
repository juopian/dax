...
void main(List<String> args) {
  ...
  defineAst(outputDir, "Expr", [
    ...
    "Dict     : Map<Expr,Expr> entries",
    "NamedArgs : Map<String,Expr> entries",
    "Then     : Expr future, Token name, Expr then",
    "Conditional: Expr condition, Expr thenBranch, Expr elseBranch",
    "Arrayif  : Expr condition, Expr thenBranch, Expr? elseBranch",
    "Anonymous: Token name, List<Token> params, List<Stmt> body",
    "Mapping  : Expr callee, Token name, Expr lambda",
    ...
    "IndexSet : Expr object, Expr name, Expr value",
  ...
  defineAst(outputDir, "Stmt", [
    ...
    "Functional : Token name, List<Token> params, Map<Token,Object?> namedParams, List<Stmt> body",
